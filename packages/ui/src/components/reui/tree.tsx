...
import { ItemInstance, hotkeysCoreFeature, syncDataLoaderFeature } from "@headless-tree/core"
...
function Tree({
  ...
  const treeLabel = props["aria-label"]
  const containerProps =
    tree && typeof tree.getContainerProps === "function"
      ? tree.getContainerProps(treeLabel)
      : {}
...
export { Tree, TreeItem, TreeItemLabel, TreeDragLine, hotkeysCoreFeature, syncDataLoaderFeature }
